...
#include <pkg/dem/MembraneNode.hpp>//**************4-19

namespace yade { // Cannot have #include directive inside.


class Gl1_MembraneNode : public GlShapeFunctor {
private:
	// for stripes
...
public:
	...
	// clang-format off
	YADE_CLASS_BASE_DOC_STATICATTRS(Gl1_MembraneNode,GlShapeFunctor,"Renders :yref:`Sphere` object",
	...
	// clang-format on
	RENDERS(MembraneNode);
};

REGISTER_SERIALIZABLE(Gl1_MembraneNode);
