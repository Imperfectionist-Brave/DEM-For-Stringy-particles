...
//#include "Thread.hpp"//使用哪一个较好 线整体 以及 线的一段？

#ifdef YADE_OPENMP
	#include<omp.h>
#endif
namespace yade { // Cannot have #include directive inside.
	class NODEdriver : public FieldApplier {
		...
		YADE_CLASS_BASE_DOC_ATTRS_CTOR_PY(NODEdriver, GlobalEngine, "Engine integrating newtonian motion equations.",
			...
			((Real, kn, 2000, , "norm Stiffness N/m"))
	...
	REGISTER_SERIALIZABLE(NODEdriver);
}
