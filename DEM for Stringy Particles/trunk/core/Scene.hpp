...
#include<pkg/dem/Node.hpp>
#include<pkg/dem/NodeForceContainer.hpp>
//#include<pkg/dem/FEContainer.hpp>
...
public:
	...
	NodeForceContainer nodeforces;//2024 5-29
	...
	YADE_CLASS_BASE_DOC_ATTRS_CTOR_PY(Scene,Serializable,"Object comprising the whole simulation.",
		...
		((shared_ptr<NodeContainer>,_nodes,new NodeContainer,Attr::hidden,"Nodes contained in the scene."))//5-29
		((shared_ptr<NodeNeighborContainer>,nodes,new NodeNeighborContainer,/*Attr::hidden*/,"Bodies contained in the scene."))//***********************4-10
		((shared_ptr<ThreadContainer>,threads,new ThreadContainer,/*Attr::hidden*/,"Bodies contained in the scene."))//***********************6-5
