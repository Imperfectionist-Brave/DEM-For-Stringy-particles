...
if "CGAL" in features:
	...
	if os.path.exists(checksPath + "/data/capillaryFiles/capillaryfile.txt"):
		...
		print("checkCapillaryEngineStandalone.py missing input data file for CapillarityEngine, skip test. Can be downloaded at https://gitlab.com/yade-dev/yade-data/-/raw/main/capillaryFiles/capillaryfile.txt?inline=false.")
else:
